        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-8 flex flex-col justify-center">
            ...
            <div className="text-center mb-6">
              <h1 className="text-3xl md:text-4xl font-bold tracking-widest text-white uppercase">Friv 2.0</h1>
              <p className="text-base text-gray-400 mt-2">Bienvenido de nuevo</p>
            </div>
            ...
            <form className="flex flex-col gap-4">
              ...
              <div>
                ...
                />
                {/* <span className="text-red-400 text-sm mt-1">La contraseña es requerida</span> */}
              </div>

              {/* .form-actions */}
              <div className="text-right -mt-2 mb-2">
                <span className="text-sm font-medium text-violet-400 opacity-50 cursor-not-allowed">¿Olvidaste tu contraseña?</span>
              </div>
              
              {/* .error-message (ejemplo estático) */}
              {/* <div className="text-red-400 bg-red-500/10 border border-red-500/50 rounded-lg p-3 text-center font-medium">
              ...
              */}
              ...
              {/* .login-button */}
              <button 
                className="w-full p-3 text-lg font-semibold min-h-[50px] bg-violet-600 text-white rounded-lg hover:bg-violet-700 transition-colors" 
                type="submit"
              >
                Iniciar Sesión
            ...
            <p className="text-center text-sm text-gray-400 mt-6">
              ...
              <Link to="/register" className="font-medium text-violet-400 hover:text-violet-300 ml-1">
                Regístrate aquí
              </Link>
            </p>
          </div>
